...
- **Groq**: Free tier, no credit card, no billing setup. Defaults to `llama-3.3-70b-versatile`. Customize
  model with `DAISY_GROQ_MODEL` (e.g. `llama-3.1-8b-instant` for lower latency).
