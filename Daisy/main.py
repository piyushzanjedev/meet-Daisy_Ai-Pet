...
tray menu (commands), the Gemini brain (Q&A), and the voice recognition
engine (run, walk, jump, sit, exit, and voice questions) with global
...
class DaisyApp(QtCore.QObject):
    def __init__(self):
        ...
        # Greet with a cute, time-aware message as soon as she appears
        ...
        self.tray.setToolTip("Daisy — AI Desktop Pet (Hold CapsLock to Talk)")
    ...
    def listen_voice_command(self):
        ...
        self.pet.say("🎤 Listening... (Say: run, walk, jump, sit, exit)", seconds=5)
